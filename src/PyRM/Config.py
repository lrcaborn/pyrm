...
class ConfigBassSlow(ConfigBass):
	name = "Bass Slow"
	note_length_range = [1, ConfigBass.TICKS_PER_QUARTERNOTE*2]
	volume_range = [90, 100]
	pitch_range = [26, 60]
	tempo_range = [60, 90]
...
class ConfigBassFast(ConfigBass):
	name = "Bass Fast"
	note_length_range = [1, ConfigBass.TICKS_PER_QUARTERNOTE]
	volume_range = [90, 110]
	pitch_range = [26, 48]
	tempo_range = [150, 180]
	note_count_range = [100, 200]
...
class ConfigDrumBullyFast(ConfigDrumBully):
	name = "BullyDrumFast"
	note_length_range = [1, ConfigBase.TICKS_PER_QUARTERNOTE/2]
	tempo_range = [150, 180]
	note_count_range = [2500,3000]
...
class ConfigPad(ConfigBase):
	name = "Pad"
	note_length_range = [1, ConfigBase.TICKS_PER_QUARTERNOTE*8]
	volume_range = [80, 100]
	pitch_range = [21, 108] # A0 to C8
	tempo_range = [60, 80]
